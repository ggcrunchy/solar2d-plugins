    ...
    lua_State *L)
{
    switch(op->kind)
    {
        ...
        case EcsIPtr: // STEVE CHANGE TODO in 64-bit
            ...
            break;
        case EcsUPtr: // STEVE CHANGE TODO in 64 bit
...
//////////////////////////
    ...
    case EcsOpU32:
        ...
        break;
    case EcsOpU64: // STEVE CHANGE TODO
    ...
    case EcsOpI32:
        lua_pushinteger(L, *(int32_t*)ECS_OFFSET(base, op->offset));
        break;
    case EcsOpI64: // STEVE CHANGE TODO
    ...
    case EcsOpIPtr: // STEVE CHANGE TODO in 64-bit
        ...
        break;
    case EcsOpUPtr: // STEVE CHANGE TODO in 64-bit
...
static void deserialize_type(lua_State *L, int idx, ecs_meta_cursor_t *c, int depth)
{
    ...
    while(lua_next(L, idx))
    {
        ...
        switch(vtype)
        {
            ...
            case LUA_TNUMBER:
            {
                if(lua_isinteger(L, -1)) // STEVE CHANGE: TODO this is a no-op right now... not sure if it includes entities
                {
...
ecs_iter_t *ecs_lua_to_iter(lua_State *L, int idx)
{
    ...
    // STEVE CHANGE
    // if(lua_getfield_t(L, idx, "interrupted_by") == LUA_TNUMBER) it->interrupted_by = lua_tointeger(L, -1);
    lua_getfield(L, idx, "interrupted_by");

    getentity(L, -1, &it->interrupted_by);
    // /STEVE CHANGE
