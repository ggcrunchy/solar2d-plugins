...
public: // <- STEVE CHANGE, needed for operator new() / delete()
    ...
    __declspec(align(64)) struct TableInfo {
...
public:
    ...
    protected:
        ...
        mutable typename std::aligned_storage<sizeof(ref_pair),
                                              std::alignment_of<ref_pair>::value>::type data;
...
template <class Key, class T, class Hash, class Pred>
    __declspec(thread) typename cuckoohash_map<Key, T, Hash, Pred>::TableInfo**
