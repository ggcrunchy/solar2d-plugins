...
include $(CLEAR_VARS)
LOCAL_MODULE := libplugin.libtess2

LOCAL_C_INCLUDES := \
	$(SRC_DIR) $(BR_DIR) $(CEU_DIR) $(PLUGIN_DIR)/../math_libraries

LOCAL_SRC_FILES := \
	$(SRC_DIR)/plugin.libtess2.cpp $(TESS_DIR)/bucketalloc.c \
	$(TESS_DIR)/dict.c $(TESS_DIR)/geom.c $(TESS_DIR)/mesh.c $(TESS_DIR)/priorityq.c \
	$(TESS_DIR)/sweep.c $(TESS_DIR)/tess.c \
