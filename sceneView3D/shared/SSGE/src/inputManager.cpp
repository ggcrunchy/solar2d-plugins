...
void InputManager::processInput(bool &done, unsigned int deltaT){// STEVE CHANGE
/*
    SDL_Event event;
...
void InputManager::handleEvent(void/*SDL_Event*/ * event, bool &done, unsigned int deltaT){ // <- STEVE CHANGE
// /STEVE CHANGE
/*
