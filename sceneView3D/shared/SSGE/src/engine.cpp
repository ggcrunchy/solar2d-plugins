...
void Engine::run(){
    ...
    while(!done){
        ++count;
        start = 0;//SDL_GetTicks(); //Could probably be its own timer class, but we're keeping things simple here <- STEVE CHANGE TODO
        ...
        deltaT = 0;//SDL_GetTicks() - start; <- STEVE CHANGE TODO
