...
ne10_neon_source := \
    ...
    $(NE10_MODULES)/imgproc/NE10_rotate.neon.s \
...
LOCAL_C_INCLUDES := \
	$(SRC_DIR) $(BR_DIR) $(CEU_DIR) $(NE10_DIR)/common $(NE10_DIR)/inc $(MATH_LIBRARIES)
...
ifeq ($(TARGET_ARCH_ABI),armeabi-v7a)
    LOCAL_CFLAGS += -DHAVE_NEON=1 -DENABLE_NE10_IMG_ROTATE_RGBA_NEON
endif
