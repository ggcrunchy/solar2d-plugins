...
if [ $OS == Windows_NT ]
then
    ANDROID_NDK="D:/crystax-ndk-10.3.2"
    LIBS_SRC_DIR=$CORONA_ROOT/Corona/android/lib/Corona/libs/armeabi-v7a
    CMD="cmd //c "
else
    ANDROID_NDK="/Applications/crystax-ndk-10.3.1"
...
echo Done.
echo $path/libs/armeabi-v7a/libplugin.clipper.so
