...
@set LUA_INCLUDE=%CORONA_ROOT%/Corona/shared/include/lua
@set LUA_LIB=%CORONA_ROOT%/Corona/win/lib/lua.lib
@set LUA_EXE=%CORONA_ROOT%/Corona/win/bin/lua.exe
...
:RELEASE
@set DO_CL=cl.exe /nologo /c /MD /Ox /W3 /Zi /D_CRT_SECURE_NO_DEPRECATE /DLUA_FFI_BUILD_AS_DLL
rem /I"msvc"
