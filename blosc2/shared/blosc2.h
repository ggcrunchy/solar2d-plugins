...
#define BLOSC2_VERSION_STRING   "2.8.1.dev"  /* string version.  Sync with above! */
...
static const blosc2_io BLOSC2_IO_DEFAULTS = {
    /*.id = */BLOSC2_IO_FILESYSTEM, // <- STEVE CHANGE
    /*.params = */NULL//,  <- STEVE CHANGE
};
 ...
 * detected, this number will be negative.
 */
BLOSC_EXPORT int64_t blosc2_schunk_append_buffer(blosc2_schunk *schunk, const void *src, int32_t nbytes); // <- STEVE CHANGE
